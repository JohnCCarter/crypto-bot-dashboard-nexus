-- ============================================
-- 🗄️ SUPABASE TRADING BOT DATABASE SCHEMA (FIXED)
-- ============================================
-- Fixed version - run each section separately if you get errors

-- ============================================
-- STEG 1: SKAPA ALLA TABELLER FÖRST
-- ============================================
...
-- ============================================
-- STEG 2: LÄGG TILL CONSTRAINTS (KÖR SEPARAT)
-- ============================================
...
ALTER TABLE positions ADD CONSTRAINT positions_side_check 
...
ALTER TABLE alerts ADD CONSTRAINT alerts_type_check 
    CHECK (type IN ('risk', 'trade', 'system', 'error'));

ALTER TABLE alerts ADD CONSTRAINT alerts_severity_check 
    CHECK (severity IN ('low', 'medium', 'high', 'critical'));

-- ============================================
-- STEG 3: SKAPA INDEX (KÖR SEPARAT)
-- ============================================
