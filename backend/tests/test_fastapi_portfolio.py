...
def mock_portfolio_manager():
    ...
    portfolio_manager.calculate_allocations = AsyncMock(return_value=[
        {
            "symbol": "tBTCUSD",
            "percentage": 50.0,
            "amount": 50000.0,
    ...
    portfolio_manager.process_signals = AsyncMock(return_value=[
        {
            "symbol": "tBTCUSD",
            "action": "buy",
            "amount": 0.1,
    ...
    portfolio_manager.get_portfolio_status = AsyncMock(return_value={
    ...
    portfolio_manager.rebalance_portfolio = AsyncMock(return_value={
        "trades": [
            {
                "symbol": "tBTCUSD",
                "action": "buy",
...
def mock_risk_manager():
    ...
    # Configure mock responses using AsyncMock
    risk_manager.assess_portfolio_risk = AsyncMock(return_value={
...
def mock_live_portfolio_service():
    ...
    # Configure mock responses using AsyncMock
    mock_service.get_live_portfolio_snapshot = AsyncMock(return_value=portfolio_snapshot)
    ...
    mock_service.get_portfolio_performance = AsyncMock(return_value=[performance_metric])
