...
class TestWebSocketMocked:
    ...
    @pytest.mark.asyncio
    async def test_handle_market_subscription(self, mock_websocket, mock_websocket_services):
    ...
    @pytest.mark.asyncio
    async def test_websocket_user_endpoint_auth(self, mock_websocket, mock_websocket_services):
