...
def get_live_portfolio_snapshot():
    ...
    try:
        ...
        logger.info(f"✅ [API] Portfolio snapshot returned: ${snapshot.total_value:.2f} total value")
...
def get_position_value():
    ...
    try:
        ...
        logger.info(f"✅ [API] Position value calculated: ${position_value['market_value']:.2f}")
...
def validate_trade():
    ...
    try:
        ...
        logger.info(f"✅ [API] Trade validation: {validation_result['valid']} - {validation_result['reason']}")
...
def get_market_overview():
    ...
    try:
        ...
        for symbol in symbols:
            try:
                market_context = live_data.get_live_market_context(symbol, timeframe='5m', limit=50)
        ...
        response_data = {
            ...
            'status': 'success',
            'timestamp': market_overview[0]['timestamp'] if market_overview and market_overview[0].get('timestamp') else None
        }
