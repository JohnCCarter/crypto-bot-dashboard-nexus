...
def register(app):
    ...
    def update_strategy_weight(strategy_name):
        ...
        try:
            ...
            return jsonify({"error": f"Failed to update strategy weight: {str(e)}"}), 500
    ...
    def get_probability_config():
        ...
        try:
            ...
            return jsonify({"error": f"Failed to get probability config: {str(e)}"}), 500
    ...
    def update_probability_config():
        ...
        try:
            ...
            if "probability_settings" in data:
                ...
                for key in ["confidence_threshold_buy", "confidence_threshold_sell", "confidence_threshold_hold", "risk_score_threshold"]:
                ...
                if success:
                    ...
                    return jsonify({"error": "Failed to update probability settings"}), 500
            else:
                return jsonify({"error": "probability_settings field is required"}), 400
                
        except Exception as e:
            return jsonify({"error": f"Failed to update probability config: {str(e)}"}), 500
