...
def register(app):
    ...
    def place_order():
        ...
        try:
            ...
            current_app.logger.info(
                f"✅ [Orders] Order placed: {order['id']}"
            )
    ...
    def cancel_order(order_id: str):
        ...
        try:
            ...
            current_app.logger.info(
                f"✅ [Orders] Order cancelled: {order_id}"
            )
    ...
    def get_order_history():
        ...
        try:
            ...
            if not exchange_service:
                current_app.logger.warning(
                    "⚠️ [Orders] No exchange service for history"
                )
                return jsonify([]), 200
            ...
            current_app.logger.info(
                f"✅ [Orders] Retrieved {len(order_history)} "
                f"historical orders"
            )
    ...
    def get_order_status(order_id: str):
        ...
        try:
            ...
            current_app.logger.info(
                f"✅ [Orders] Order status retrieved: {order_id}"
            )
